...
public class ModeleAffichage implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1738416391341476174L;
	...
	//AYOUB BOUISRI
	/**
	 * methode qui retourne une valeur en unites reelles a partir d'une valeur en pixel
	 * @param pixelX pixel en X
	 * @param pixelY pixel en Y
	 * @return
	 */
	public Vecteur getInUnitesReelles( double pixelX,double pixelY) {
		return new Vecteur(pixelX / pixelsParUniteX,pixelY / pixelsParUniteY);
	}
	/**
	 * methode qui retourne une valeur en pixel a partir d'une unite reelle.
	 * @param uniteX unites reelles en X
	 * @param pixelY unites reelles en Y
	 * @return La valeur des unites rentrees en pixel
	 */
	public Vecteur getInPixel(double uniteX,double uniteY) {
		return new Vecteur(uniteX * pixelsParUniteX,uniteY*pixelsParUniteY);
	}
